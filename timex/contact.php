  ...
  <div class="container">
    <div class="row g-4">
      <div class="col-lg-5">
        ...
        <div class="d-flex gap-3 mb-3">
          <div class="timex-plan-icon blue"><i class="fa-solid fa-envelope" aria-hidden="true"></i></div>
          <div>
        ...
        <div class="d-flex gap-3">
          <div class="timex-plan-icon blue"><i class="fa-brands fa-whatsapp" aria-hidden="true"></i></div>
          <div>
          ...
          <form id="timexContactForm" action="api/submit.php" method="post" novalidate>
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control" id="f-message" name="message" rows="4" placeholder="Tell us about your attendance process or demo goals"></textarea>
              </div>
              <div class="col-12">
...
<script>
(function () {
  var form = document.getElementById('timexContactForm');
