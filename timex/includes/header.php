      ...
      <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0 align-items-lg-center gap-lg-1">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu shadow-sm border-0" aria-labelledby="timexProductsMenu">
            ...
            <li>
              <a class="dropdown-item suite-product-item" href="<?php echo htmlspecialchars($product['url']); ?>" <?php echo (strpos($product['url'], 'http') === 0 && strpos($product['url'], TIMEX_MAIN_SITE_URL) !== 0) ? 'target="_blank" rel="noopener"' : ''; ?>>
